...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSetBatchInsertStatementId(interfaze);
        addSetBatchUpdateStatementId(interfaze);
        addSetWhereClauseStatementId(interfaze);
    ...
    private void addSetWhereClauseStatementId(Interface interfaze) {
        if (introspectedTable.getRules()
    ...
    private void addSetBatchUpdateStatementId(Interface interfaze) {
        if (introspectedTable.getRules()
                .generateBaseColumnList()) {
    ...
    private void addSetBatchInsertStatementId(Interface interfaze) {
